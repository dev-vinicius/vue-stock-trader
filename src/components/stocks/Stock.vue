  ...
  <v-flex class="pr-3 pb-3" xs12 md6 lg4>
    ...
    <v-card>
      <v-container fill-height>
        <v-text-field label="Quantidade" type="number" v-model.number="quantity" :error="insuficientFunds || !Number.isInteger(quantity)"/>
        <v-btn class="green darken-3 white--text ml-3" 
          @click="buyStock"
